...
// document.getElementById("fart").addEventListener('click', function() {
//   console.log("farrrrt")
...
const removeActive = () => {
  ...
  tableHeads.forEach(function(el) {
...
const updatePhase = (timer) => {
  switch (true) {
      case (timer < 100):
          removeActive()
          document.getElementById("atrialSystole").classList.add("active")
          // console.log("Atrial Systole");
          break;
      case (timer < 160):
          removeActive()
          document.getElementById("isovolumetricContraction").classList.add("active")    
          // console.log("Isovolumetric Contraction");
          break;
      case (timer < 255):
          removeActive()
          document.getElementById("rapidVentricularEjection").classList.add("active") 
          // console.log("Rapid Ventricular Ejection");
          break;
      case (timer < 400):
          removeActive()
          document.getElementById("slowVentriculeEjection").classList.add("active")     
          // console.log("Slow Ventricular Ejection");
          break;
      case (timer < 480):
          removeActive()
          document.getElementById("isovolumetricRelaxation").classList.add("active") 
          // console.log("Isovolumetric Relaxation");
          break;
      case (timer < 590):
        removeActive()    
        document.getElementById("rapidFillingPhase").classList.add("active")     
          // console.log("Rapid Filling Phase");
          break;
      default:   
          removeActive() 
          document.getElementById("diastasis").classList.add("active")
  }
}
...
//   duration: 800,
//   // onUpdate: (self) => ($timer.innerHTML = self.currentTime)
// });
