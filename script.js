...
// document.getElementById("atrialSystole").classList.remove("active")
// document.getElementById("isovolumetricContraction").classList.remove("active")
// document.getElementById("rapidVentricularEjection").classList.remove("active")
// document.getElementById("slowVentriculeEjection").classList.remove("active")
// document.getElementById("isovolumetricRelaxation").classList.remove("active")
// document.getElementById("rapidFillingPhase").classList.remove("active")
// document.getElementById("diastasis").classList.remove("active")
...
.call(() => {
  ...
  changeClass("highlight", "#rapidFillingPhase", "add")
  // open tricuspid valve
  document.getElementById("wrightTable").classList.add("openTricuspid")
  // numbers
  if (seekDirection === 'forward') {
    const count1 = new CountUp('row2col5', -2, { startVal: 2, duration: numberAnimationDuration/1000 });
    count1.start();
  }
}, 0)
// diastasis
.call(() => {
  ...
  changeClass("highlight", ".tableHead", "remove")
  changeClass("highlight", "#diastasis", "add")
}, 110)
// atrial systole
.call(() => {
  ...
  // numbers
  if (seekDirection === 'forward') {
    const count1 = new CountUp('row4col4', 6, { startVal: 3, duration: numberAnimationDuration/1000 });
    count1.start();
  } else if (seekDirection === 'backward') {
    const count1 = new CountUp('row4col4', 3, { startVal: 6, duration: numberAnimationDuration/1000 });
    count1.start();
  }
}, 320)
// isovolumetric contraction
.call(() => {
  ...
  // close tricuspid valve
  document.getElementById("wrightTable").classList.remove("openTricuspid")
  // numbers
  if (seekDirection === 'forward') {
    const count1 = new CountUp('row5col4', 3, { startVal: 6, duration: numberAnimationDuration/1000 });
    count1.start();
    const count2 = new CountUp('row5col5', 9, { startVal: 4, duration: numberAnimationDuration/1000 });
    count2.start();
  } else if (seekDirection === 'backward') {
    const count1 = new CountUp('row5col4', 6, { startVal: 3, duration: numberAnimationDuration/1000 });
    count1.start();
    const count2 = new CountUp('row5col5', 4, { startVal: 9, duration: numberAnimationDuration/1000 });
    count2.start();
  }
}, 410)
// rapid ventricular ejection
.call(() => {
  ...
  // numbers
  if (seekDirection === 'forward') {
    const count1 = new CountUp('row6col5', 25, { startVal: 10, duration: numberAnimationDuration/1000 });
    count1.start();
    const count2 = new CountUp('row6col6', 25, { startVal: 10, duration: numberAnimationDuration/1000 });
    count2.start();
  } else if (seekDirection === 'backward') {
    const count1 = new CountUp('row6col5', 10, { startVal: 25, duration: numberAnimationDuration/1000 });
    count1.start();
    const count2 = new CountUp('row6col6', 10, { startVal: 25, duration: numberAnimationDuration/1000 });
    count2.start();
  }
}, 450)
...
.call(() => {
  ...
  changeClass("highlight", "#slowVentricularEjection", "add")
    // numbers
  if (seekDirection === 'forward') {
    const count1 = new CountUp('row7col5', 15, { startVal: 25, duration: numberAnimationDuration/1000 });
    count1.start();
    const count2 = new CountUp('row7col6', 15, { startVal: 25, duration: numberAnimationDuration/1000 });
    count2.start();
  } else if (seekDirection === 'backward') {
    const count1 = new CountUp('row7col5', 25, { startVal: 15, duration: numberAnimationDuration/1000 });
    count1.start();
    const count2 = new CountUp('row7col6', 25, { startVal: 15, duration: numberAnimationDuration/1000 });
    count2.start();
  }
}, 560)
// isovolumetric relaxation
.call(() => {
  ...
  document.getElementById("wrightTable").classList.remove("openPulmonary")
      // numbers
  if (seekDirection === 'forward') {
    const count1 = new CountUp('row8col5', 6, { startVal: 15, duration: numberAnimationDuration/1000 });
    count1.start();
    const count2 = new CountUp('row8col6', 17, { startVal: 15, duration: numberAnimationDuration/1000 });
    count2.start();
  } else if (seekDirection === 'backward') {
    const count1 = new CountUp('row8col5', 15, { startVal: 6, duration: numberAnimationDuration/1000 });
    count1.start();
    const count2 = new CountUp('row8col6', 15, { startVal: 17, duration: numberAnimationDuration/1000 });
    count2.start();
  }
}, 700)
...
// const updatePhase = (timer) => {
//   switch (true) {
//     // 0 to 110
//       // case (timer < 110):
//       //     removeClass("highlight", ".tableHead") 
//       //     document.getElementById("rapidFillingPhase").classList.add("active", "highlight")
//       //     document.getElementById("wrightTable").classList.add("openTricuspid")
//       //     // console.log("Atrial Systole");
//       //     break;


//       // // 110 to 320 - do this at 110
//       // case (timer < 320):
//       //     removeClass("highlight", ".tableHead") 
//       //     document.getElementById("diastasis").classList.add("active", "highlight")   
//       //     // console.log("Isovolumetric Contraction");
//       //     break;
//       // 320 to 410 - do this at 320
//       case (timer < 410):
//           removeClass("highlight", ".tableHead") 
//           document.getElementById("atrialSystole").classList.add("active", "highlight")
//           // console.log("Rapid Ventricular Ejection");
//           break;
//       // 410 to 450 - do this at 410
//       case (timer < 450):
//           removeClass("highlight", ".tableHead") 
//           document.getElementById("isovolumetricContraction").classList.add("active", "highlight")
//           document.getElementById("wrightTable").classList.remove("openTricuspid")
//           // console.log("Slow Ventricular Ejection");
//           break;
// 450 to 560 - do this at 450
//       case (timer < 560):
//           removeClass("highlight", ".tableHead") 
//           document.getElementById("rapidVentricularEjection").classList.add("active", "highlight")
//           // console.log("Isovolumetric Relaxation");
//           break;
//       case (timer < 700):
//         removeClass("highlight", ".tableHead")  
//         document.getElementById("slowVentriculeEjection").classList.add("active", "highlight")

//           // let isCalled = false;
//           // const runOnce = () => {
//           //   if(isCalled) return;
//           //     animateBolus("#rapidFillingPhase", 16.666, 3, '30px', 20)
//           //     isCalled = true;
//           // }
//           // runOnce()

//           // console.log("Rapid Filling Phase");
//           break;
//       default:   
//           removeClass("highlight", ".tableHead") 
//           // setBolus("#rapidFillingPhase", 16.666, 1, '0px')
//           // setBolus("#rapidFillingPhase", 16.666, 1, '0px')
//           document.getElementById("isovolumetricRelaxation").classList.add("active", "highlight")
//   }
// }
...
//     {
//       duration: 100,
//       d: "M190.96 286.53C158.7 300.07 129.15 327.44 133.39 365.6 133.39 369.6 132.39 374.6 128.39 377.6 112.87 384.9 94.03 388.04 83.26 402.22 85.82 403.72 89.09 407.02 93.26 412.6 128.05 459.1 159.91 495.95 205 512 294 539 287 498 273 440 263.69 384.87 228.75 323.96 190.96 286.53Z"
//     }, "<<"
//   )
// .add(
//     $ventriclel,
//     {
//       duration: 100,
//       d: "M319.39 276.6C308.39 276.6 292.39 263.6 287.39 272.6 275.61 294.48 256.75 314.23 233.19 321.13 236.99 328.4 240.64 334.8 243.84 339.96 252.11 353.32 271 366 284 392 301 421 325 447 356 449S377 366 358.32 298.66C354.64 289.51 349.03 276.96 344.5 264.29 342.34 265.3 340.3 266.7 338.4 268.6 332.4 272.6 326.4 277.6 319.4 276.6Z"
//     }, "<<"
//   )
// .add(
//     $atriuml,
...
//       reversed: true,
//       delay: stagger(32),
//       ...svg.createMotionPath('.superior-vena-cava-short')
//     }, "<<"
//   )
//   .add(
//     ".atrial-systole-l-arrow",
//     {
//       ease: 'linear',
//       visibility: 'visible',
//       keyframes: {                 
...
//       reversed: true,
//       delay: stagger(32),
//       ...svg.createMotionPath('.pulmonary-vein-short')
//     }, "<<"
//   )
//   // ISOVOLUMETRIC CONTRACTION
//   // close tricuspid and mitral valves
//   // .call(() => {
//   //   toggleActive("atrialSystole") //off
//   //   toggleActive("isovolumetricContraction") //on
//   // })
//   .add(
//     $tricuspid1,
//     {
...
//   )
//   // .call(() => {
//   //   toggleActive("isovolumetricContraction") //off
//   //   toggleActive("rapidVentricularEjection")
//   // }, 165)
//   // .call(() => {
//   //   toggleActive("rapidVentricularEjection") //off
//   //   toggleActive("slowVentriculeEjection")
//   // }, 255)
//   .add(
//     $ventricler,
...
//       d: "M202 309C196 310 200.87 327.3 207.82 330.83 212.39 333.15 222.42 334.69 228.07 331.02L225.73 326.2C219.51 327.14 216 327 211 325 205 322 204 309 202 309Z"
//     }, "140"
//     // pulmonary valve opens at 0.14s
//   )
//   .add(
//     $pulmonary2,
//     {
...
//     }, "<<"
//   )
//   // aorta and pulmonary artery arrows
  
//   .add(
//     ".rapid-ejection-pulmonary-arrow",
//     {
//       ease: 'linear',
//       visibility: 'visible',
//       keyframes: {                 
...
//       reversed: true,
//       delay: stagger(60),
//       ...svg.createMotionPath('.pulmonary-artery')
//     }, "155"
//     // aorta and pulmonary artery flow starts at 0.155s
//   )
//   .add(
//     ".rapid-ejection-aorta-arrow",
//     {
//       ease: 'linear',
//       visibility: 'visible',
//       keyframes: {                 
...
//       reversed: true,
//       delay: stagger(62),
//       ...svg.createMotionPath('.aorta')
//     }, "<<"
//   )
//   // superior vena cava and pulmonary vein push

//   .add(
//     ".reduced-ejection-pulmonary-vein-arrow",
//     {
//       ease: 'linear(0, .5 45%, 1)',
//       visibility: 'visible',
//       keyframes: {                 
//         '0%'  : { opacity: 0  },
//         '5%' : { opacity: 1 },
...
//       reversed: true,
//       delay: stagger(120),
//       ...svg.createMotionPath('.pulmonary-vein')
//     }, "180"
//     // push starts at .18s
//   )
//   // close aortic and pulmonary valves
//   .add(
//     $pulmonary1,
//     {
//       duration: 40,
...
//   // tricuspid and mitral valves open
//   // .call(() => {
//   //   toggleActive("slowVentriculeEjection") //off
//   //   toggleActive("isovolumetricRelaxation")
//   // }, 400)
//   .add(
//     $tricuspid1,
...
//   )
//   // .call(() => {
//   //   toggleActive("isovolumetricRelaxation") //off
//   //   toggleActive("rapidFillingPhase")
//   // }, 460)
//   // .call(() => {
//   //   toggleActive("rapidFillingPhase") //off
//   //   toggleActive("diastasis")
//   // }, 600)
//   .add(
//     $ventricler,
//     {
//       duration: 400,
//       d: "M190.96 286.53C158.7 300.07 129.15 327.44 133.39 365.6 133.39 369.6 132.39 374.6 128.39 377.6 112.87 384.9 94.03 388.04 83.26 402.22 85.82 403.72 89.09 407.02 93.26 412.6 128.05 459.1 159.91 495.95 206.6 506.87 253.29 517.79 263.69 486.32 263.69 431.8 263.69 384.87 228.75 323.96 190.96 286.53Z"
//     }, "<<"
//   )
//   .add(
//     $ventriclel,
//     {
//       duration: 400,
//       d: "M319.39 276.6C308.39 276.6 292.39 263.6 287.39 272.6 275.61 294.48 256.75 314.23 233.19 321.13 236.99 328.4 240.64 334.8 243.84 339.96 252.11 353.32 271 366 286 383 310 407 327 441 354 436S377 366 358.32 298.66C354.64 289.51 349.03 276.96 344.5 264.29 342.34 265.3 340.3 266.7 338.4 268.6 332.4 272.6 326.4 277.6 319.4 276.6Z"
//     }, "<<"
//   )
//   .add(
//     $heartwall,
...
//       //   toggleActive("atrialSystole")
//       // },
//       d: "M128.89 40.51C90.5 105.67 113.63 216.02 176.14 261.49 187.29 269.99 197.9 281.72 208.34 295.09 205.75 286.19 203.42 276.92 201.47 267.6 197.11 246.86 194.6 225.92 195.27 208.49 195.61 199.74 200.29 185.27 209.98 172.65 218.11 162.07 232.4 149.46 254.29 149.46 255.98 149.46 257.7 149.54 259.42 149.69 279.25 151.46 294.23 159.17 306.27 165.37 315.25 169.99 323.01 173.99 330.49 174.55 331.27 174.61 332.1 174.64 332.96 174.64 350.95 174.64 377.16 161.91 377.42 161.78L378.24 161.38 378.78 166.67 382.51 203.18 383.03 208.24C330.11 206.44 357.76 251.84 374.15 294.65 406.97 380.37 370.97 514.26 303.62 526.72 183.58 548.93 114.01 482.49 83.07 411.34 79.55 425.33 82.23 450.52 80.46 468.49H3.66C52.53 320.94-59.97 274.27 50.69 120.87 70.57 91.34 61.45 62.53 61.97 46.4L67.38 45.93 121.82 41.14 128.89 40.51Z"
//     }, "<<"
//   )
//   // BOLUS ANIMATIONS IN TABLE
//   .add(
...
//   // RETURN BOLUS ONCE EACH ROW IS COMPLETE
//   .call(() => setBolus("#rapidFillingPhase", 16.666, 1, '0px'), 590)

//   // ADD CONTRACTION AND RELAXATION BORDERS
//   // this one is just an example for future use
//   .add(
//     '#rapidFillingPhase td:nth-child(3)',
//     {
//       duration: 110,
